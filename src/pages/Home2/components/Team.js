    ...
    <div id='team' data-color="white" className="team-section section font-[PPNeueMachina] py-20">
      ...
      <div className="list w-full mt-10 px-10">
        {[
          ...
          {   name: "Anjali Ojha", title: "AI and Chatbot Specialist", imgSrc: an },
          {   name: "Harsh Vardhan Chauhan", title: "Frontend Developer", imgSrc: hv },
          ...
          <div key={member.id} className="listitem border-b-2 border-black w-full py-[3rem] f relative">
