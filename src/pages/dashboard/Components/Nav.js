        ...
        <div className='relative'>
          ...
          {showDropdown && (
            <div className='absolute right-0 mt-2 bg-[#b0c4c4] text-[#13544e] rounded-md shadow-lg w-[12rem]'>
              ...
              <Link to="/Jobs" className='block px-4 py-2 text-[#13544e] hover:bg-[#b56b61] hover:text-[#fff4f0] rounded-md text-center' onClick={() => setShowDropdown(false)}>Update Jobs</Link>
