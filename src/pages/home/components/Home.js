    ...
    <div className="h-[100vh] flex items-center justify-between font-montserrat">
      <div className="flex flex-col max-w-[30vw] min-w-[30vw] p-[3vw_4.3vw]">
        ...
        <span className="mt-[1vw] text-[0.8vw] font-medium">
          We provide innovative solutions to streamline your business operations
          and enhance productivity. Discover our cutting-edge tools and services
          tailored to meet your unique needs.
        </span>
        <Link to="/dashboard">
          <button className="mt-[2vw] bg-[#130035] w-[9vw] h-[3vw] text-[#edebf0] rounded-[2vw] shadow-lg hover:bg-[#1a003e] hover:shadow-xl transform hover:scale-105 transition-all duration-300">
            Find Work
          </button>
        </Link>
      </div>
      ...
      <div className="flex flex-col max-w-[30vw] min-w-[30vw] p-[3vw_4.3vw] font-aganirya">
        ...
        <span className="mt-[1vw] text-[0.8vw] font-medium">
          Search for top talent and amazing job opportunities in one place. Our
          platform connects you with the best candidates and employers, making
          job searches and hiring processes seamless.
        </span>
        <Link to="/dashboardF">
          <button className="mt-[2vw] bg-[#130035] w-[9vw] h-[3vw] text-[#edebf0] rounded-[2vw] shadow-lg hover:bg-[#1a003e] hover:shadow-xl transform hover:scale-105 transition-all duration-300">
            Find Talent
